...
try {
    ...
    log_event('Token da PipeRun indisponível em ListarCotacoes: ' . $e->getMessage());
...
try {
    $pdo = new PDO("sqlsrv:server=$dbhost;Database=$db", $user, $password, [
      ...
      $stmtTot = $pdo->prepare(
        "SELECT COUNT(*) FROM _USR_CONF_SITE_HISTORICO_COTACAO WHERE DS_EMAIL = ? AND NR_CPFCNPJ = ?"
    );
